...
summary: A statically generated Next.js 16 portfolio with MDX in git, no client components, and a schema that fails the build rather than render a blank card.
role: Sole author
