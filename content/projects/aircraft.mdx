...
verified: false
complete: false
ogImage: /images/og/aircraft.png
---
...
This is the client stage of a three-part aircraft system built since January 2026, and the only stage that is not built. The [plane scraper](/projects/plane-scraper) and the [aircraft management engine](/projects/aircraft-management-engine) are both source-verified; this page is not.
