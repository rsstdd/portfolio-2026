---
title: Hydro sensor
summary: A Python edge agent that speaks Atlas Scientific over FTDI, reads pH, conductivity, and temperature probes, and fans telemetry to independent sinks.
role: Sole author
