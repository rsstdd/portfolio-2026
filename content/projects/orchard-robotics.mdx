...
summary: A Next.js, Flask, and Cloud SQL system projecting harvest volume from a growth rate, date range, and diameter band, over precomputed fruit geometry.
role: Sole author
