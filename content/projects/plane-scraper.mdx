...
The repository carries fifty-eight editor local-history snapshots under `.history`, roughly 121KB of them, along with committed editor settings. They are noise, and they are the first thing visible to anyone browsing the file list.
