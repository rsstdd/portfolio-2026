...
summary: A Raspberry Pi and Arduino prototype that reads sensors over Firmata, streams them to a browser over Socket.io, and sends SMS when a reading leaves range.
role: Sole author
