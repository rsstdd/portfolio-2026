...
the CLAUDE.md file, not in the individual prompt. The example further down is
the one [this site](/projects/this-site) is built with. A well-designed one means
