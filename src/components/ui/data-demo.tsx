      ...
      <table className="mt-8 w-full max-w-[640px] border-collapse tabular-nums">
        <thead>
          <tr>
            <th
              scope="col"
              className="border-b border-line p-3 text-left text-overline uppercase text-muted"
            >
              Model
            </th>
            <th
              scope="col"
              className="border-b border-line p-3 text-right text-overline uppercase text-muted"
            >
              HP
            </th>
            <th
        ...
        <tbody>
          {rows.map((row) => (
            <tr
              key={row.model}
              className="transition-colors duration-(--duration-fast) hover:bg-well"
            >
